.. ppmg documentation master file, created by
   sphinx-quickstart on Thu Jul  8 23:29:30 2021.
   You can adapt this file completely to your liking, but it should at least
   contain the root `toctree` directive.

Welcome to ppmg's documentation!
================================
...
- Ron Begleiter, Ran El-Yaniv, and Golan Yona.
  "On Prediction Using Variable Order Markov Models". In: Journal of Artificial Intelligence Research 22 (2004), pp. 385-421.
...
- Cleary, J., & Witten, I. (1984). Data compression using adaptive coding and
  partial string matching. IEEE Transactions on Communications, COM-32(4), 396–402.
